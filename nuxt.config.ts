  ...
  app: {
    head: {
      ...
      meta: [
        ...
        { property: 'og:image', content: 'https://corescale.dev/og-image-new.jpeg' },
        { property: 'og:image:width', content: '1424' },
        { property: 'og:image:height', content: '752' },
        { property: 'og:image:alt', content: 'Corescale - web development, solution architecture and AI agents' },
        { property: 'og:site_name', content: 'Corescale' },
        { name: 'twitter:card', content: 'summary_large_image' },
        { name: 'twitter:image', content: 'https://corescale.dev/og-image-new.jpeg' },
