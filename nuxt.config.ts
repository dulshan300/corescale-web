  ...
  app: {
    head: {
      ...
      meta: [
        ...
        { property: 'og:image', content: 'https://corescale.dev/og-share.png' },
        { property: 'og:image:width', content: '1200' },
        { property: 'og:image:height', content: '630' },
        { property: 'og:image:alt', content: 'Corescale - Automate the busywork and grow faster with custom web apps and AI agents' },
        { property: 'og:site_name', content: 'Corescale' },
        { name: 'twitter:card', content: 'summary_large_image' },
        { name: 'twitter:image', content: 'https://corescale.dev/og-share.png' },
